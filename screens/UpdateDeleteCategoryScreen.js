...
export default function UpdateDeleteCategoryScreen({ navigation, route }) {
  const { category, username, role, isOnline = true } = route.params || {};
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE}/api/category/update/${category.id}`,
        {
          method: 'PUT',
          headers: {
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              const response = await fetch(
                `${API_BASE}/api/category/delete/${category.id}`,
                {
                  method: 'DELETE',
                  headers: {
                    Authorization: `Bearer ${token}`,
        ...
        <View style={isTablet ? styles.tabletCenterWrapper : null}>
          <View style={styles.tabletContent}>
            ...
            <TouchableOpacity style={styles.updateBtn} onPress={handleUpdate}>
              <Text style={styles.updateBtnText}>UPDATE CATEGORY</Text>
            </TouchableOpacity>
