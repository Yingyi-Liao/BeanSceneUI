...
export default function UpdateDeleteItemScreen({ isOnline = true, onBack }) {
  ...
  // Mock existing item values
  const [itemName, setItemName] = useState('Garlic Bread');
  ...
  const handleUpdate = () => {
    ...
    Alert.alert('Success', `Item "${itemName}" has been updated!`);
  };
